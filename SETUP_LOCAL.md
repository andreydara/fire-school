...
If the lock file is being deliberately regenerated by a trainer, use `requirements.txt` instead.
...
The course notebooks do **not** contain a trainer's private Google Cloud project ID.
